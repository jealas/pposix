...
SCENARIO("File descriptors can be released") {
    GIVEN("an empty file descriptor") {
        ...
        WHEN("released") {
            ...
            THEN("the file descriptor remains empty") {
                require_is_empty(fd);
            }
    ...
    GIVEN("a non-empty file descriptor") {
        ...
        WHEN("released") {
            ...
            THEN("the file descriptor is emptied") {
                require_is_empty(fd);
            }

            AND_THEN("the released raw file descriptor is the same as what was used to construct the file descriptor") {
...
public:
    ...
    unsigned close_count() const noexcept {
        return *close_count_;
    }
