#ifndef PPOSIX_FILE_PERMISSION_HPP
#define PPOSIX_FILE_PERMISSION_HPP
...
namespace pposix::file {
    ...
    namespace literals::permission_literals {
        ...
        namespace detail {
            ...
            str_to_permission(char const *const c_str, size_t len, permission(*char_to_permission)(char)) {
                permission p{};
...
#endif //PPOSIX_FILE_PERMISSION_HPP
